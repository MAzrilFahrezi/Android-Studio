...
import static com.if5b.kamus.databases.DatabaseContract.EnglishIndoensiaColumns.ENGLISH_INDONESIA_DESCRIPTION;
import static com.if5b.kamus.databases.DatabaseContract.EnglishIndoensiaColumns.ENGLISH_INDONESIA_TITLE;
import static com.if5b.kamus.databases.DatabaseContract.TABLE_ENGLISH_INDONESIA_NAME;
...
public class KamusHelper {
    ...
    public void insertTransactionDataEnglishIndonesia(Kamus kamus){
        String sql = "INSERT INTO " + TABLE_ENGLISH_INDONESIA_NAME + " (" +
                ENGLISH_INDONESIA_TITLE + ", " + ENGLISH_INDONESIA_DESCRIPTION +
                ") VALUES (?, ?) ";
